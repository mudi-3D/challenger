...
createStyles(){
    ...
    link.href=`https://cdn.jsdelivr.net/gh/RodriguezJose92/challenger@latest/index.css`; /* custom this path */
...
createModal(){
    ...
    modalMudi.innerHTML=`
        <div class="iframeMudi3D">
            <button class="closeModalMudi" style="color:#14140f">X</button>
            <iframe class="modelMudi" src="${this.dataServer.URL_WEB}"></iframe>
            <div class="containerBtnsActions">
                <svg xmlns="http://www.w3.org/2000/svg" id="imgARBtn" class="imgBtnAR" viewBox="0 0 317 112">
                <defs>
                    <style>
                    .cls-1_modal{fill:#14140f;stroke:#14140f;stroke-miterlimit:10;stroke-width:3px;}
                ...
                <div id="containerQR" class="containerQRMudi" style="background-color:#14140f">
                    ...
                    <div class="containerText">
                        ...
                        <div class="titleContainer">
                            <div class="iconTitle">
                                <img class="stepMudi step1" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/challenger@latest/assets/step3.webp">
                            </div>
                        ...
                        <div class="titleContainer">
                            <div class="iconTitle">
                                <img class="stepMudi step2" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/challenger@latest/assets/step4.webp">
                            </div>
                        ...
                        <div class="titleContainer">
                            <div class="iconTitle">
                                <img class="stepMudi step3" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/challenger@latest/assets/step2.webp">
                            </div>
                        ...
                        <div class="titleContainer">
                            <div class="iconTitle">
                                <img class="stepMudi step4" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/challenger@latest/assets/step1.webp">
                            </div>
...
setTimeout(() => {
    const skuElement = document.querySelector('.ag-product-details__cod .skuReference');

    if (skuElement) {
        const sku = skuElement.textContent.trim(); 
        const container = document.querySelector('.ag-product-details__image.product-image');
